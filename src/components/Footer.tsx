...
const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: Github,
      href: "https://github.com/Shivank2508",
      label: "GitHub"
    },
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/shivank-tyagi-a75ba91a0/",
      label: "LinkedIn"
    },
    {
      icon: Mail,
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © {currentYear} Shivank Tyagi. All rights reserved.
          </p>
